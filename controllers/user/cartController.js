...
//     add a logic of remove item using wislistItemId
...
//     // Logic to remove an item using wishlistItemId
//     if (wishlistItemId) {
//       cart.items = cart.items.filter(item => item._id.toString() !== wishlistItemId.toString());
//       console.log("Item removed using wishlistItemId:", wishlistItemId);
//     }
